        ...
        <View style={styles.container}>
            ...
            <ScrollView style={styles.scrollContainer} >
                <View style={styles.subContainer} >
                    ...
                    <View style={{ justifyContent: 'center', alignItems: 'center', borderBottomWidth: 0.5, borderBottomColor: colors.grey, padding: RFPercentage(2), width: "100%", flex: 1, backgroundColor: "#f6f6f6", alignItems: 'center', justifyContent: 'center' }} >
                        <Text style={{ fontWeight: '600', fontSize: RFPercentage(2.8), color: 'black' }} >Invitations</Text>
                    </View>

                    {data.map((item, i) => (
                        <TouchableOpacity key={i} style={{ justifyContent: 'center', alignItems: 'center', flexDirection: 'row', borderBottomWidth: 0.5, borderBottomColor: 'white', padding: RFPercentage(2), width: "100%", flex: 1, alignItems: 'center', justifyContent: 'center' }} >
