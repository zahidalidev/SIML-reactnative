        ...
        <View style={styles.container}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={styles.scrollContainer} >
                <View style={styles.subContainer} >
                    ...
                    {/* profile picture */}
                    <ImageBackground borderRadius={RFPercentage(10)} source={selectedImage} style={{ marginTop: RFPercentage(3), borderRadius: RFPercentage(10), width: RFPercentage(17), height: RFPercentage(17), borderColor: colors.grey, borderWidth: 1, flexDirection: 'column', alignItems: 'flex-end', justifyContent: 'flex-end' }}>
                    ...
                    <View style={{ marginTop: RFPercentage(2), flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'center' }}>
                        <Text style={{ fontSize: RFPercentage(2.2), color: colors.darkGrey }} >Tap to edit your profile</Text>
                    </View>
